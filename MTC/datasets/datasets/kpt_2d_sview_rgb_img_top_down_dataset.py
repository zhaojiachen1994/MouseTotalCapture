...
class Kpt2dSviewRgbImgTopDownDataset(Dataset, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        # self.ann_info['face_ids'] = dataset_info.face_ids
        # self.ann_info['tail_ids'] = dataset_info.tail_ids
        # self.ann_info['claws_ids'] = dataset_info.claws_ids
        # self.ann_info['body_ids'] = dataset_info.body_ids
        ...
        if coco_style:
            # print(data_cfg['dataset_channel'])
            # self.coco = COCO(ann_file, test_index=data_cfg['dataset_channel'])    # to select the test index, not work for wholebody data
